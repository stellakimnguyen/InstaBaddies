  ...
  render() {
    ...
    const dialogMarkup = loading ? (
      ...
      <Grid container spacing={0}>
        <Grid item sm={false} className={this.props.classes.topoStuff}>
          <hr className={this.props.classes.invisibleSeparator} />
    ...
    return (
      <Fragment>
        <MyButton
          ...
          tip="Comments"
          tipClassName={this.props.classes.expandButton}
        >
        ...
        {this.state.open ? // statement needed as redux props not loaded if state.open == false
        <CommentSection>
          {dialogMarkup}
        </CommentSection>
        : null // do nothing
        ...
        >
          <MyButton
            tip="Close"
            onClick={this.handleClose} //this.handleClose
            tipClassName={this.props.classes.closeButton}
          >
            <CloseIcon />
          </MyButton>
