...
class PostComments extends React.Component {
  ...
  //   if (nextProps.isExpanded !== this.state.open) {
  //     this.setState({ open: nextProps.isExpanded }, () => console.log("state has been updated"););
  //   }
  // }
  ...
  render() {
    ...
    const dialogMarkup = loading ? (
      ...
      <div>
        <AllComments>
          <Comments triggerComments={this.props.triggerComments} comments={comments} />
        </AllComments>
