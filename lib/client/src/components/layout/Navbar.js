...
class Navbar extends Component {
  ...
  handleEscKey = event => {
    ...
    console.log("you pressed enter in inputbaseee, handle esc key");
    console.log(event.key);
    this.setState({
      searchInput: event.target.value
    });
    console.log("text on changeee ", this.state.searchInput);
    if (event.key === "Enter") {
  ...
  handleSubmit = event => {
    event.preventDefault();
    console.log("you pressed enter in handlesubmittt");
    // if (event.key === "Enter") {
    console.log("submitted from serachhhh");
    console.log("user text : ", this.state.searchInput.trim());
    console.log("signed in ass : ", this.props.user.credentials.username);
    const searchUser = this.state.searchInput.trim();
    ...
    axios
      ...
      .then(res => {
        ...
        console.log("user exists1: ", this.state.results);
    ...
    // if (Object.size(this.state.results) > 0) {
    //   console.log("user exists2: ", this.state.results);
    // } else {
    //   console.log("user does not exist ", this.state.results);
    // }
    // if (event.target.value) {
  ...
  //   // console.log("text on change :: ", event.target.value);
  //   this.setState({
  //     searchInput: event.target.value
  //   });
  //   console.log("text on changeee ", this.state.searchInput);
