...
export class Profile extends Component {
  followedUser = () => {
    if (this.props.user.following && this.props.user.following["user10"])
      return true;
    else return false;
  };

  followUser = () => {
    this.props.followUser(this.props.user.username, "user20");
  };

  unfollowUser = () => {
    this.props.unfollowUser(this.props.user.username, "user20");
  };
  handleImageChange = e => {
    // 1. Get the file
